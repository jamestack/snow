...
func (HealthCheckResponse_ServingStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_consul_check_proto_enumTypes[0].Descriptor()
}

func (HealthCheckResponse_ServingStatus) Type() protoreflect.EnumType {
	return &file_consul_check_proto_enumTypes[0]
}
...
func (HealthCheckResponse_ServingStatus) EnumDescriptor() ([]byte, []int) {
	return file_consul_check_proto_rawDescGZIP(), []int{1, 0}
}
...
func (x *HealthCheckRequest) Reset() {
	*x = HealthCheckRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_consul_check_proto_msgTypes[0]
...
func (*HealthCheckRequest) Descriptor() ([]byte, []int) {
	return file_consul_check_proto_rawDescGZIP(), []int{0}
}
...
func (x *HealthCheckResponse) Reset() {
	*x = HealthCheckResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_consul_check_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*HealthCheckResponse) Descriptor() ([]byte, []int) {
	return file_consul_check_proto_rawDescGZIP(), []int{1}
}
...
var File_consul_check_proto protoreflect.FileDescriptor

var file_consul_check_proto_rawDesc = []byte{
	0x0a, 0x12, 0x63, 0x6f, 0x6e, 0x73, 0x75, 0x6c, 0x5f, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x2e, 0x70,
...
var (
	file_consul_check_proto_rawDescOnce sync.Once
	file_consul_check_proto_rawDescData = file_consul_check_proto_rawDesc
)

func file_consul_check_proto_rawDescGZIP() []byte {
	file_consul_check_proto_rawDescOnce.Do(func() {
		file_consul_check_proto_rawDescData = protoimpl.X.CompressGZIP(file_consul_check_proto_rawDescData)
	})
	return file_consul_check_proto_rawDescData
}

var file_consul_check_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_consul_check_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_consul_check_proto_goTypes = []interface{}{
	(HealthCheckResponse_ServingStatus)(0), // 0: grpc.health.v1.HealthCheckResponse.ServingStatus
	(*HealthCheckRequest)(nil),             // 1: grpc.health.v1.HealthCheckRequest
	(*HealthCheckResponse)(nil),            // 2: grpc.health.v1.HealthCheckResponse
}
var file_consul_check_proto_depIdxs = []int32{
...
func init() { file_consul_check_proto_init() }
func file_consul_check_proto_init() {
	if File_consul_check_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_consul_check_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_consul_check_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_consul_check_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_consul_check_proto_goTypes,
		DependencyIndexes: file_consul_check_proto_depIdxs,
		EnumInfos:         file_consul_check_proto_enumTypes,
		MessageInfos:      file_consul_check_proto_msgTypes,
	}.Build()
	File_consul_check_proto = out.File
	file_consul_check_proto_rawDesc = nil
	file_consul_check_proto_goTypes = nil
	file_consul_check_proto_depIdxs = nil
}
